    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        if(indexPath.section == 1){
            ...
            let video:AVPlayer!
             ...
             video = AVPlayer(url: URL(string: FormData.shared.songs[FormData.shared.selectedItem!][indexPath.row])!)
                               
            
            print(FormData.shared.songs[FormData.shared.selectedItem!][indexPath.row])
